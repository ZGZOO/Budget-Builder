 ...
 */
public class InputNumbersForSavingsGoalFrame extends JFrame{
    ...
    public InputNumbersForSavingsGoalFrame(BudgetProfileModel budgetProfileModel){
    ...
    private JPanel getButtonPanel(){
        ...
        backButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                //add actions
                dispose();
                CategoryFrame categoryFrame = new CategoryFrame(budgetProfileModel);
            }
        });
        ...
        saveButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                String spendingCategory = spendingNameTextField.getText();
                double spendingAmount = Double.valueOf(spendingValueTextField.getText().substring(2));
                Spending spending = new Spending(spendingCategory, spendingAmount);
                
                String incomeCategory = incomeNameTextField.getText();
                double incomeAmount = Double.valueOf(incomeValueTextField.getText().substring(2));
                Income income = new Income(incomeCategory, incomeAmount);
                
                BudgetEditor budgetEditor = new BudgetEditor(budgetProfileModel.getProfile());
        ...
        buttonPanelLayout.setHorizontalGroup(
            ...
            .addGroup(buttonPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(backButton, GroupLayout.DEFAULT_SIZE, 90, Short.MAX_VALUE)
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
