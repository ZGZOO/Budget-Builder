...
public class InputNumbersForIncomeNeededFrame extends JFrame{
    ...
    public InputNumbersForIncomeNeededFrame(BudgetProfileModel budgetProfileModel){
    ...
    private JPanel getButtonPanel(){
        ...
        saveButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                double savingsAmount = Double.valueOf(savingValueTextField.getText().substring(2));
                
                BudgetEditor budgetEditor = new BudgetEditor(budgetProfileModel.getProfile());
                budgetEditor.addSpending(spending);
                budgetEditor.addSavings(savingsAmount);
            }
        });
